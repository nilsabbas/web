...
class JLTMA_Timeline extends Widget_Base {
    ...
    public function get_style_depends() {
        return ['font-awesome-5-all', 'font-awesome-4-shim', 'master-addons-main-style'];
    }
    ...
    protected function register_controls() {
        $this->start_controls_section( 'ma_el_timeline_section_start', [
            'label' => __( 'Timeline', 'master-addons' ),
        ] );
        $this->add_control( 'ma_el_timeline_type', [
        ...
        $this->add_control( 'ma_el_timeline_design_type', [
        ...
        $repeater->start_controls_tab( 'ma_el_custom_timeline_tab_content', [
            'label' => __( 'Content', 'master-addons' ),
        ] );
        $repeater->add_control( 'ma_el_custom_timeline_date_type', [
        ...
        $repeater->add_control( 'ma_el_custom_timeline_date', [
        ...
        $repeater->add_control( 'ma_el_custom_timeline_date_format', [
        ...
        $repeater->add_control( 'ma_el_custom_timeline_date_custom_format', [
        ...
        $repeater->add_control( 'ma_el_custom_timeline_label', [
        ...
        $repeater->add_control( 'ma_el_custom_timeline_link', [
        ...
        $repeater->add_control( 'ma_el_custom_timeline_content', [
            'label'   => '',
        ...
        $repeater->start_controls_tab( 'ma_el_custom_timeline_tab_media', [
            'label' => __( 'Media', 'master-addons' ),
        ] );
        $repeater->add_control( 'ma_el_custom_timeline_image', [
        ...
        $repeater->add_group_control( Group_Control_Image_Size::get_type(), [
            'name'    => 'ma_el_custom_timeline_image_size',
        ...
        $this->add_control( 'ma_el_custom_timeline_items', [
         ...
         * MA Timeline: Layout
         */
        $this->start_controls_section( 'ma_el_timeline_section_layout', [
            'label' => __( 'Layout', 'master-addons' ),
            'tab'   => Controls_Manager::TAB_STYLE,
        ] );
        $this->add_responsive_control( 'ma_el_timeline_align', [
        ...
        $this->add_control( 'ma_el_timeline_reverse', [
        ...
        $this->add_control( 'ma_el_timeline_cards_align', [
        ...
        $this->add_responsive_control( 'ma_el_timeline_horizontal_spacing', [
        ...
        $this->add_responsive_control( 'ma_el_timeline_vertical_spacing', [
         ...
         * MA Timeline: Image Style
         */
        $this->start_controls_section( 'ma_el_timeline_section_images', [
            'label' => __( 'Images', 'master-addons' ),
            'tab'   => Controls_Manager::TAB_STYLE,
        ] );
        $this->add_control( 'ma_el_timeline_images_align', [
        ...
        $this->add_control( 'ma_el_timeline_images_spacing', [
        ...
        $this->add_control( 'ma_el_timeline_images_border_radius', [
         ...
         * MA Timeline: Posts
         */
        $this->start_controls_section( 'ma_el_timeline_section_posts_style', [
        ...
        $this->add_control( 'ma_el_timeline_title_heading', [
        ...
        $this->add_control( 'ma_el_timeline_title_color', [
        ...
        $this->add_control( 'ma_el_timeline_titles_spacing', [
            'label'     => __( 'Spacing', 'master-addons' ),
            'type'      => Controls_Manager::SLIDER,
            'default'   => [
                'size' => '',
        ...
        $this->add_control( 'ma_el_timeline_excerpt_heading', [
        ...
        $this->add_control( 'ma_el_timeline_excerpt_color', [
        ...
        $this->add_responsive_control( 'ma_el_timeline_excerpt_padding', [
         ...
         * MA Timeline: Date
         */
        $this->start_controls_section( 'ma_el_timeline_section_date', [
            'label' => __( 'Date', 'master-addons' ),
            'tab'   => Controls_Manager::TAB_STYLE,
        ] );
        $this->add_group_control( Group_Control_Typography::get_type(), [
        ...
        $this->add_control( 'ma_el_timeline_date_color', [
        ...
        $this->add_control( 'ma_el_timeline_date_bg_color', [
        ...
        $this->add_responsive_control( 'ma_el_timeline_date_padding', [
            'label'      => __( 'Padding', 'master-addons' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px'],
            'selectors'  => [
        ...
        $this->add_responsive_control( 'ma_el_timeline_date_vertical_spacing', [
            'label'     => __( 'Vertical Spacing', 'master-addons' ),
            'type'      => Controls_Manager::SLIDER,
            'default'   => [
                'size' => '',
        ...
        $this->add_responsive_control( 'cards_margin', [
        ...
        $this->add_responsive_control( 'cards_content_padding', [
        ...
        $this->add_control( 'cards_border_radius', [
            'label'      => __( 'Border Radius', 'master-addons' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%'],
            'selectors'  => [
        ...
        $this->add_responsive_control( 'animate_in', [
        ...
        $this->start_controls_tab( 'tab_cards_default', [
            'label' => __( 'Default', 'master-addons' ),
        ] );
        $this->add_responsive_control( 'cards_color', [
            'label'     => __( 'Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_responsive_control( 'cards_background_color', [
            'label'     => __( 'Background Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .timeline-item__content-wrapper,
        ...
        $this->start_controls_tab( 'tab_cards_hover', [
            'label' => __( 'Hover', 'master-addons' ),
        ] );
        $this->add_responsive_control( 'cards_color_hover', [
            'label'     => __( 'Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_responsive_control( 'cards_background_color_hover', [
            'label'     => __( 'Background Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->end_controls_tab();
        $this->start_controls_tab( 'tab_cards_focused', [
            'label' => __( 'Focused', 'master-addons' ),
        ] );
        $this->add_responsive_control( 'cards_color_focused', [
            'label'     => __( 'Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_responsive_control( 'cards_background_color_focused', [
            'label'     => __( 'Background Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
         ...
         */
        $this->start_controls_section( 'section_arrow', [
         ...
         */
        $this->start_controls_section( 'section_dates', [
        ...
        $this->add_responsive_control( 'dates_margin', [
        ...
        $this->start_controls_tab( 'tab_dates_default', [
            'label' => __( 'Default', 'master-addons' ),
        ] );
        $this->add_responsive_control( 'dates_color', [
            'label'     => __( 'Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->end_controls_tab();
        $this->start_controls_tab( 'tab_dates_hover', [
            'label' => __( 'Hover', 'master-addons' ),
        ] );
        $this->add_responsive_control( 'dates_color_hover', [
            'label'     => __( 'Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->end_controls_tab();
        $this->start_controls_tab( 'tab_dates_focused', [
            'label' => __( 'Focused', 'master-addons' ),
        ] );
        $this->add_responsive_control( 'dates_color_focused', [
            'label'     => __( 'Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control( 'line_background', [
            'label'     => __( 'Background Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'global'    => [
        ...
        $this->add_control( 'progress_background', [
        ...
        $this->add_control( 'line_location', [
        ...
        $this->add_control( 'line_border_radius', [
            'label'      => __( 'Border Radius', 'master-addons' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%'],
            'selectors'  => [
         ...
         * MA Timeline: Points
         */
        $this->start_controls_section( 'ma_el_timeline_section_points', [
            'label' => __( 'Points', 'master-addons' ),
            'tab'   => Controls_Manager::TAB_STYLE,
        ] );
        $this->add_control( 'ma_el_timeline_points_content', [
        ...
        $this->add_control( 'ma_el_timeline_points_image', [
        ...
        $this->add_control( 'ma_el_timeline_selected_global_icon', [
        ...
        $this->start_controls_tab( 'ma_el_timeline_points_default', [
            'label' => __( 'Default', 'master-addons' ),
        ] );
        $this->add_responsive_control( 'ma_el_timeline_points_size', [
        ...
        $this->add_responsive_control( 'ma_el_timeline_icons_size', [
        ...
        $this->add_responsive_control( 'ma_el_timeline_content_size', [
        ...
        $this->add_control( 'ma_el_timeline_points_background', [
            'label'     => __( 'Background Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'global'    => [
                'default' => Global_Colors::COLOR_SECONDARY,
        ...
        $this->add_control( 'ma_el_timeline_icons_color', [
        ...
        $this->end_controls_tab();
        $this->start_controls_tab( 'ma_el_timeline_points_hover', [
            'label' => __( 'Hover', 'master-addons' ),
        ] );
        $this->add_control( 'ma_el_timeline_points_size_hover', [
        ...
        $this->add_control( 'ma_el_timeline_points_background_hover', [
            'label'     => __( 'Background Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '',
            'selectors' => [
        ...
        $this->add_control( 'ma_el_timeline_icons_color_hover', [
            'label'     => __( 'Points Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '',
            'selectors' => [
        ...
        $this->end_controls_tab();
        $this->start_controls_tab( 'ma_el_timeline_points_focused', [
            'label' => __( 'Focused', 'master-addons' ),
        ] );
        $this->add_control( 'ma_el_timeline_points_size_focused', [
            'label'     => __( 'Scale', 'master-addons' ),
            'type'      => Controls_Manager::SLIDER,
            'default'   => [
                'size' => 1,
        ...
        $this->add_control( 'ma_el_timeline_points_background_focused', [
            'label'     => __( 'Background Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => 'red',
            'global'    => [
        ...
        $this->add_control( 'ma_el_timeline_icons_color_focused', [
            'label'     => __( 'Points Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '',
            'selectors' => [
    ...
    protected function ma_el_timeline_global_render_attributes() {
        ...
        $this->add_render_attribute( [
            ...
            'ma_el_timeline_posts'   => [
                'class' => ['jltma-blog-timeline-post', 'jltma-timeline__item', 'timeline-item'],
            ],
            'item'                   => [
                'class' => ['jltma-timeline__item', 'timeline-item'],
            ],
            'icon-wrapper'           => [
                'class' => [
                    'jltma-icon',
            ...
            'image'                  => [
                'class' => ['timeline-item__img', 'jltma-post__thumbnail', 'jltma-timeline-entry-thimbnail'],
            ],
            'content'                => [
    ...
    protected function jltma_render_line() {
        ...
        ?>>
			<div <?php 
        echo $this->get_render_attribute_string( 'line-inner' );
        ?>></div>
		</div>
	<?php 
    }
    ...
    protected function render() {
        ...
        ?>
		<div <?php 
        echo $this->get_render_attribute_string( 'ma_el_timeline_wrapper' );
        ?>>
    ...
    public function jltma_vertical_timeline() {
		...
		<div <?php 
            ...
            ?>>
			<div <?php 
            echo $this->get_render_attribute_string( 'point' );
            ?>>
				<?php 
            echo $this->parse_text_editor( $point_content );
            ?>
			</div>
			<div <?php 
            echo $this->get_render_attribute_string( 'card-wrapper' );
            ?>>
				<div class="jltma-timeline-post-inner">
					<<?php 
            echo esc_attr( $card_tag );
            ?> <?php 
            echo $this->get_render_attribute_string( $card_key );
            ?>>
            ...
            if ( $item['ma_el_custom_timeline_image']['url'] ) {
                ?>
								<div <?php 
                echo $this->get_render_attribute_string( 'image' );
                ?>>
									<?php 
                echo Group_Control_Image_Size::get_attachment_image_html( $item, 'ma_el_custom_timeline_image' );
                ?>
								</div>
							<?php 
            }
            ...
            ?>
							...
							<div <?php 
            echo $this->get_render_attribute_string( $wysiwyg_key );
            ?>>
								<?php 
            echo $this->parse_text_editor( $item['ma_el_custom_timeline_content'] );
            ?>
							</div>
							<?php 
			...
			<div <?php 
            echo $this->get_render_attribute_string( 'meta-wrapper' );
            ?>>
				<?php 
            $this->render_custom_card_meta( $index, $item );
            ?>
...
<?php 
    ...
    protected function render_card_arrow() {
        ?>
	<div <?php 
        echo $this->get_render_attribute_string( 'arrow' );
        ?>></div>
<?php 
    }
    ...
    protected function render_custom_card_meta( $index, $item ) {
        ...
        ?>
				<div <?php 
        echo $this->get_render_attribute_string( $meta_key );
        ?>>
					<?php 
        ...
        if ( $item['ma_el_custom_timeline_date_type'] == 'custom' ) {
            ...
            $date = $this->get_date_formatted(
                true,
                $item['ma_el_custom_timeline_date_custom_format'],
                $item['ma_el_custom_timeline_date_format'],
                null,
                null,
                $item['ma_el_custom_timeline_date']
            );
	...
	<?php 
        ...
        foreach ( $settings['ma_el_custom_timeline_items'] as $index => $item ) {
            ...
            $this->add_render_attribute( [
                $item_key    => [
                    'class' => ['elementor-repeater-item-' . esc_attr( $content_id ), 'jltma-blog-timeline-post'],
                ],
                $slider_item => [
                    'class' => ['jltma-slider__item', 'jltma-swiper__slide', 'swiper-slide'],
                ],
                $card_key    => [
                    'class' => 'timeline-item__card',
                ],
            ...
            ?>
					...
					<div <?php 
            echo $this->get_render_attribute_string( $slider_item );
            ?>>
						<<?php 
            echo esc_attr( $card_tag );
            ?> <?php 
...
<?php 
    ...
    protected function ma_timeline_points_text( $type, $index = false, $item = false ) {
        ...
        $this->add_render_attribute( $point_key, 'class', ['jltma-timeline-post-type-icon', 'timeline-item__point__text'] );
	...
	<div <?php 
        echo $this->get_render_attribute_string( 'ma_el_timeline_posts' );
        ?>>
		<div <?php 
        echo $this->get_render_attribute_string( 'point' );
        ?>><?php 
        ...
        ?>>
					<div class="timeline-item__content-wrapper">
						...
						<?php 
        if ( has_post_thumbnail() && (isset( $settings['ma_el_timeline_post_thumbnail'] ) && !empty( $settings['ma_el_timeline_post_thumbnail'] )) ) {
            ?>
							<div <?php 
            echo $this->get_render_attribute_string( 'image' );
            ?>>
								<?php 
            echo $this->render_posts_thumbnail();
            ?>
							</div>
						<?php 
        }
        ?>
						...
						<div class="timeline-item__meta meta">
							<?php 
        $this->render_date( true, get_the_ID() );
        ?>
						</div><!-- meta -->

						<div class="jltma-timeline-entry-content">
							<?php 
        if ( $settings['ma_el_timeline_post_title'] == "yes" ) {
            ?>
								<<?php 
            echo tag_escape( $title_html_tag );
            ?> class="jltma-timeline-entry-title">
									<?php 
            if ( $settings['ma_el_timeline_post_title_link'] == "yes" ) {
                ?><a href="<?php 
                the_permalink();
                ?>"><?php 
            }
...
<?php 
    ...
    protected function render_date( $echo = true, $post_id = null ) {
        ...
        $date = $this->get_date_formatted(
            $custom,
            esc_attr( $settings['ma_el_timeline_date_custom_format'] ),
            esc_attr( $settings['ma_el_timeline_date_format'] ),
            esc_attr( $settings['ma_el_timeline_time_format'] ),
            $post_id
        );
        if ( !$echo ) {
