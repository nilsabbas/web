    ...
    <div class="">
        <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade <?= $product_tabBodyActive; ?>" id="pills-product" role="tabpanel"
                ...
                <div class="na-pdtbrochure pt-0">
                
                <?php
                    get_template_part("template-parts/available-ranges-product");
                ?>
...
<script type="text/javascript" src="<?= get_template_directory_uri(); ?>/assets/js/custom.js" id="na-custom-js">
